...
var StatisticService = /** @class */ (function () {
    ...
    StatisticService.prototype.getGame = function (model) {
        debugger;
        return this.http.post(this.rootUrl + 'Statistic/GetGame', model);
    };
    StatisticService.prototype.getPage = function (model) {
        return this.http.post(this.rootUrl + 'Statistic/Pagination', model);
    };
    StatisticService.prototype.getUserPage = function (model) {
        return this.http.post(this.rootUrl + 'Statistic/GetUserStat', model);
    };
